...
- Full log file: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log-summary/20260622_121553_p2g_final_syntax_check_full_log.md
...
nuaa           2  0.2  0.0  13516  3744 ?        S    12:15   0:00 bash ./scripts/run_with_log.sh p2g_final_syntax_check bash -lc python3 -m py_compile scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py && bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh
nuaa         115  0.0  0.0  13516  2180 ?        S    12:15   0:00 bash ./scripts/run_with_log.sh p2g_final_syntax_check bash -lc python3 -m py_compile scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py && bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh
nuaa         116  1.3  0.0  27208 14112 ?        S    12:15   0:00 python3 /home/nuaa/ZHY/FUEL_PLANNER_V3/scripts/generate_full_run_log.py --task-name p2g_final_syntax_check --command bash -lc python3 -m py_compile scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py && bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh --exit-code 0 --raw-log /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_121546_p2g_final_syntax_check.md --summary-log /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log-summary/20260622_121548_p2g_final_syntax_check_summary.md --workspace /home/nuaa/ZHY/FUEL_PLANNER_V3
```
...
## Metadata
- Date: 2026-06-22T12:15:46+08:00
- Host: nuaa-dell
- User: nuaa
- Workspace: /home/nuaa/ZHY/FUEL_PLANNER_V3
- Pwd: /home/nuaa/ZHY/FUEL_PLANNER_V3
- Shell: /bin/bash
- Command: bash -lc python3 -m py_compile scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py && bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh
- Log file: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_121546_p2g_final_syntax_check.md
...
```text
UNIFIED_SUMMARY_LOG_CREATED=/home/nuaa/ZHY/FUEL_PLANNER_V3/test-log-summary/20260622_121548_p2g_final_syntax_check_summary.md
```
...
## 13. Final Diagnosis
- Command exit code: 0.
- Raw log path: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_121546_p2g_final_syntax_check.md.
- Summary log path: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log-summary/20260622_121548_p2g_final_syntax_check_summary.md.
