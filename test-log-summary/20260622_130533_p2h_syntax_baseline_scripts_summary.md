...
nuaa           2  0.2  0.0  13516  3760 ?        S    13:05   0:00 bash ./scripts/run_with_log.sh p2h_syntax_baseline_scripts bash -lc bash -n scripts/run_p2h_route_common.sh scripts/run_p2h_route_300s_baseline.sh scripts/run_p2h_route_300s_after_fix.sh scripts/run_p2h_visual_route_300s.sh scripts/export_p2h_debug_package.sh && python3 -m py_compile scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py
nuaa          31  0.0  0.0  13516  2196 ?        S    13:05   0:00 bash ./scripts/run_with_log.sh p2h_syntax_baseline_scripts bash -lc bash -n scripts/run_p2h_route_common.sh scripts/run_p2h_route_300s_baseline.sh scripts/run_p2h_route_300s_after_fix.sh scripts/run_p2h_visual_route_300s.sh scripts/export_p2h_debug_package.sh && python3 -m py_compile scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py
nuaa          32  1.0  0.0  27460 14712 ?        S    13:05   0:00 python3 /home/nuaa/ZHY/FUEL_PLANNER_V3/scripts/generate_unified_summary_log.py --task-name p2h_syntax_baseline_scripts --command bash -lc bash -n scripts/run_p2h_route_common.sh scripts/run_p2h_route_300s_baseline.sh scripts/run_p2h_route_300s_after_fix.sh scripts/run_p2h_visual_route_300s.sh scripts/export_p2h_debug_package.sh && python3 -m py_compile scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py --exit-code 0 --raw-log /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_130533_p2h_syntax_baseline_scripts.md --workspace /home/nuaa/ZHY/FUEL_PLANNER_V3
```
...
## Generated Files
- test-log/20260622_130533_p2h_syntax_baseline_scripts.md
