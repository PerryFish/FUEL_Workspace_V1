...
./
```
- latest diff patch if available: reports/p2i_after_no_path_watchdog_and_recorder_fix_diff_20260622_140854.patch
...
nuaa           2  0.2  0.0  13516  3744 ?        S    14:08   0:00 bash ./scripts/run_with_log.sh p2i_syntax_check_after_recorder_fix bash -lc python3 -m py_compile scripts/fuel_route_rationality_recorder.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py src/FUEL/scripts/frontier_viewpoint_lite.py && bash -n scripts/run_p2i_route_common.sh scripts/run_p2i_route_full.sh scripts/run_p2i_visual_route_300s.sh scripts/run_p2i_visual_route_full.sh
nuaa          30  0.0  0.0  13516  2104 ?        S    14:08   0:00 bash ./scripts/run_with_log.sh p2i_syntax_check_after_recorder_fix bash -lc python3 -m py_compile scripts/fuel_route_rationality_recorder.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py src/FUEL/scripts/frontier_viewpoint_lite.py && bash -n scripts/run_p2i_route_common.sh scripts/run_p2i_route_full.sh scripts/run_p2i_visual_route_300s.sh scripts/run_p2i_visual_route_full.sh
nuaa          31  1.0  0.0  27736 14868 ?        S    14:08   0:00 python3 /home/nuaa/ZHY/FUEL_PLANNER_V3/scripts/generate_unified_summary_log.py --task-name p2i_syntax_check_after_recorder_fix --command bash -lc python3 -m py_compile scripts/fuel_route_rationality_recorder.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py src/FUEL/scripts/frontier_viewpoint_lite.py && bash -n scripts/run_p2i_route_common.sh scripts/run_p2i_route_full.sh scripts/run_p2i_visual_route_300s.sh scripts/run_p2i_visual_route_full.sh --exit-code 0 --raw-log /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_140854_p2i_syntax_check_after_recorder_fix.md --workspace /home/nuaa/ZHY/FUEL_PLANNER_V3
```
...
## Generated Files
- test-log/20260622_140854_p2i_syntax_check_after_recorder_fix.md
- reports/p2i_after_no_path_watchdog_and_recorder_fix_diff_20260622_140854.patch
