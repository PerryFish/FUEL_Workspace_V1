...
nuaa           2  0.5  0.0  13516  3736 ?        S    11:55   0:00 bash ./scripts/run_with_log.sh p2g_syntax_after_frontier_fix bash -lc bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_frontier_common.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh scripts/run_with_log.sh && python3 -m py_compile scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py
nuaa          33  0.0  0.0  13516  2092 ?        S    11:55   0:00 bash ./scripts/run_with_log.sh p2g_syntax_after_frontier_fix bash -lc bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_frontier_common.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh scripts/run_with_log.sh && python3 -m py_compile scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py
nuaa          34  1.2  0.0  27480 14468 ?        S    11:55   0:00 python3 /home/nuaa/ZHY/FUEL_PLANNER_V3/scripts/generate_unified_summary_log.py --task-name p2g_syntax_after_frontier_fix --command bash -lc bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_frontier_common.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh scripts/run_with_log.sh && python3 -m py_compile scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py --exit-code 0 --raw-log /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_115542_p2g_syntax_after_frontier_fix.md --workspace /home/nuaa/ZHY/FUEL_PLANNER_V3
```
...
## Generated Files
- test-log/20260622_115542_p2g_syntax_after_frontier_fix.md
