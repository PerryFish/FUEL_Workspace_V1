...
## 1. Basic Info
- Date: 2026-06-22T11:55:51+0800
- Task name: p2g_syntax_after_frontier_fix
- Workspace: /home/nuaa/ZHY/FUEL_PLANNER_V3
- Command: bash -lc bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_frontier_common.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh scripts/run_with_log.sh && python3 -m py_compile scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py
- Exit code: 0
- Raw log file: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_115542_p2g_syntax_after_frontier_fix.md
- Summary log file: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log-summary/20260622_115542_p2g_syntax_after_frontier_fix_summary.md
- Full log file: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log-summary/20260622_115548_p2g_syntax_after_frontier_fix_full_log.md
...
## Metadata
- Date: 2026-06-22T11:55:42+08:00
- Host: nuaa-dell
- User: nuaa
- Workspace: /home/nuaa/ZHY/FUEL_PLANNER_V3
- Pwd: /home/nuaa/ZHY/FUEL_PLANNER_V3
- Shell: /bin/bash
- Command: bash -lc bash -n scripts/run_p2g_frontier_300s_baseline.sh scripts/run_p2g_coverage_300s_after_fix.sh scripts/run_p2g_coverage_600s_after_fix.sh scripts/run_p2g_frontier_common.sh scripts/run_p2g_visual_coverage_300s.sh scripts/export_p2g_debug_package.sh scripts/run_with_log.sh && python3 -m py_compile scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py scripts/fuel_frontier_reachability_recorder.py scripts/analyze_frontier_scoring_and_reachability.py src/FUEL/scripts/frontier_viewpoint_lite.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py
- Log file: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_115542_p2g_syntax_after_frontier_fix.md
...
```text
UNIFIED_SUMMARY_LOG_CREATED=/home/nuaa/ZHY/FUEL_PLANNER_V3/test-log-summary/20260622_115542_p2g_syntax_after_frontier_fix_summary.md
```
...
## 13. Final Diagnosis
- Command exit code: 0.
- Raw log path: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_115542_p2g_syntax_after_frontier_fix.md.
- Summary log path: /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log-summary/20260622_115542_p2g_syntax_after_frontier_fix_summary.md.
