...
./
```
- latest diff patch if available: reports/p2h_after_route_scoring_fix_diff_20260622_131245.patch
...
nuaa           2  0.4  0.0  13516  3704 ?        S    13:12   0:00 bash ./scripts/run_with_log.sh p2h_syntax_after_scoring_fix bash -lc bash -n scripts/run_p2h_route_common.sh scripts/run_p2h_route_300s_baseline.sh scripts/run_p2h_route_300s_after_fix.sh scripts/run_p2h_visual_route_300s.sh scripts/export_p2h_debug_package.sh && python3 -m py_compile scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py src/FUEL/scripts/frontier_viewpoint_lite.py
nuaa          33  0.0  0.0  13516  2192 ?        S    13:12   0:00 bash ./scripts/run_with_log.sh p2h_syntax_after_scoring_fix bash -lc bash -n scripts/run_p2h_route_common.sh scripts/run_p2h_route_300s_baseline.sh scripts/run_p2h_route_300s_after_fix.sh scripts/run_p2h_visual_route_300s.sh scripts/export_p2h_debug_package.sh && python3 -m py_compile scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py src/FUEL/scripts/frontier_viewpoint_lite.py
nuaa          34  1.1  0.0  27596 14736 ?        S    13:12   0:00 python3 /home/nuaa/ZHY/FUEL_PLANNER_V3/scripts/generate_unified_summary_log.py --task-name p2h_syntax_after_scoring_fix --command bash -lc bash -n scripts/run_p2h_route_common.sh scripts/run_p2h_route_300s_baseline.sh scripts/run_p2h_route_300s_after_fix.sh scripts/run_p2h_visual_route_300s.sh scripts/export_p2h_debug_package.sh && python3 -m py_compile scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py src/FUEL/scripts/frontier_viewpoint_lite.py --exit-code 0 --raw-log /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_131245_p2h_syntax_after_scoring_fix.md --workspace /home/nuaa/ZHY/FUEL_PLANNER_V3
```
...
## Generated Files
- test-log/20260622_131245_p2h_syntax_after_scoring_fix.md
- reports/p2h_after_route_scoring_fix_diff_20260622_131245.patch
