...
nuaa           2  0.4  0.0  13516  3720 ?        S    14:00   0:00 bash ./scripts/run_with_log.sh p2i_syntax_check bash -lc bash -n scripts/run_p2i_route_common.sh scripts/run_p2i_route_300s_after_fix.sh scripts/run_p2i_route_900s_after_fix.sh scripts/run_p2i_visual_route_300s.sh scripts/run_p2i_visual_route_full.sh scripts/run_p2i_route_full.sh scripts/export_p2i_debug_package.sh scripts/print_fuel_run_commands.sh scripts/run_with_log.sh && python3 -m py_compile scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py scripts/fuel_run_commands_common.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py src/FUEL/scripts/frontier_viewpoint_lite.py
nuaa          30  0.0  0.0  13516  2144 ?        S    14:00   0:00 bash ./scripts/run_with_log.sh p2i_syntax_check bash -lc bash -n scripts/run_p2i_route_common.sh scripts/run_p2i_route_300s_after_fix.sh scripts/run_p2i_route_900s_after_fix.sh scripts/run_p2i_visual_route_300s.sh scripts/run_p2i_visual_route_full.sh scripts/run_p2i_route_full.sh scripts/export_p2i_debug_package.sh scripts/print_fuel_run_commands.sh scripts/run_with_log.sh && python3 -m py_compile scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py scripts/fuel_run_commands_common.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py src/FUEL/scripts/frontier_viewpoint_lite.py
nuaa          31  1.1  0.0  27740 14808 ?        S    14:00   0:00 python3 /home/nuaa/ZHY/FUEL_PLANNER_V3/scripts/generate_unified_summary_log.py --task-name p2i_syntax_check --command bash -lc bash -n scripts/run_p2i_route_common.sh scripts/run_p2i_route_300s_after_fix.sh scripts/run_p2i_route_900s_after_fix.sh scripts/run_p2i_visual_route_300s.sh scripts/run_p2i_visual_route_full.sh scripts/run_p2i_route_full.sh scripts/export_p2i_debug_package.sh scripts/print_fuel_run_commands.sh scripts/run_with_log.sh && python3 -m py_compile scripts/generate_unified_summary_log.py scripts/generate_full_run_log.py scripts/fuel_route_rationality_recorder.py scripts/analyze_route_rationality.py scripts/fuel_run_commands_common.py src/FUEL/scripts/exploration_manager_lite.py src/FUEL/scripts/p11_lite_goal_to_path_bridge.py src/FUEL/scripts/frontier_viewpoint_lite.py --exit-code 0 --raw-log /home/nuaa/ZHY/FUEL_PLANNER_V3/test-log/20260622_140003_p2i_syntax_check.md --workspace /home/nuaa/ZHY/FUEL_PLANNER_V3
```
...
## Generated Files
- test-log/20260622_140003_p2i_syntax_check.md
