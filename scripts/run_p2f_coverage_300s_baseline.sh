...
RUN_ID="p2f_coverage_300s_baseline_${STAMP}"
OUT="test-log/${STAMP}_p2f_coverage_300s_baseline_runtime.txt"
LAUNCH_PID=""
TF_PID=""
cleanup() {
...
{
  echo "# P2F coverage 300s baseline"
  echo "run_id=$RUN_ID"
  date -Is
...
echo "P2F_COVERAGE_300S_BASELINE_DONE run_id=$RUN_ID" | tee -a "$OUT"
exit "$REC"
